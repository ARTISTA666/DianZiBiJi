...
def fixture(root: Path) -> dict[str, Path | str]:
    ...
    commitment, content_hash, commitment_hash = MODULE._authority_commitment(root, freeze_manifest, freeze_payload, json.loads(question_manifest.read_text()), json.loads(gold.read_text()), json.loads(corpus.read_text()))
