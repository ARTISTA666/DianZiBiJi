...
def get_template(template_id: int, _: User = Depends(get_current_user), db: Session = Depends(get_db)) -> ExperimentTemplate:
    return db.get(ExperimentTemplate, template_id)
