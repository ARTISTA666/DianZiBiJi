...
- [论文内容润色记录-2026-09-14](论文内容润色记录-2026-09-14.md)：T-042，高星项目方法、46 处对照与完整性校验；[独立学术润色稿](毕业论文重构稿-学术润色版-2026-09-14.md)待作者审阅，未替代持窗主稿。

- **[论文范文复刻版验收-2026-09-14](论文范文复刻版验收-2026-09-14.md)**：沿用原 GitHub 引擎，按作者提供的魏潘晨论文实测封面、扉页、目录和正文图表版式；123 页 PDF。
- [格式 v1 调研及验收（已归档）](../archive/thesis-format/论文格式专用版调研与验收-2026-09-13.md)：保留官方规范与项目选型依据，版式由范文复刻版取代。

- **[三端已完成工作验收-2026-09-11](三端已完成工作验收-2026-09-11.md)**：最新验收裁决与返修条件；旧协调报告自评不等于通过。
- **[创新点增强版论文](毕业论文重构稿-创新点增强版.md)**：09-09～10独立增强版（T-031），内容返修/PDF视觉待验，与原稿并存。
...
4. **[rag-serialized-baselines-2026-09-14.md](experiments/rag-serialized-baselines-2026-09-14.md)** —— 6.6.3 承诺的两条序列化公平基线臂内部诊断批次（臂 A 笔记全文序列化 13/20、臂 B 三元组文本序列化无图结构 12/20；漂移披露同 SQL 基线臂；挂接主稿 6.6.3/6.6.5）
4. **[补证素材论文挂接表-2026-09-08.md](innovation/补证素材论文挂接表-2026-09-08.md)** —— 补证数字→主稿章节候选落点+口径红线（文字线取材入口）
5. **[论文创新点升级写作骨架-2026-09-08.md](论文创新点升级写作骨架-2026-09-08.md)** —— 新三贡献口径的主稿改造地图（作者已裁决 A-D，current；按五窗口排期落稿，识读小测方案在内 §5）
