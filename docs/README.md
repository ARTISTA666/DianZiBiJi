...
3. **[并线协作状态.md](并线协作状态.md)** —— 多 Agent 开工必读/收工必更新（窗口、任务队列、增量日志）
4. **[任务台账.md](任务台账.md)** —— 全部工作包的登记与状态（复盘入口）
5. 仓库根 [README.md](../README.md)（系统使用）与 [AGENTS.md](../AGENTS.md)（协作规则）
...
| `论文导师审阅材料包/` | **2026-06-13 冻结的历史交付物**，与 `archive/advisor-snapshots/` 大量重复；仅作提交记录，勿在此继续更新 | 作者 |
